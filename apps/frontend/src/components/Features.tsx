...
export function Features() {
  return (
    <section className="py-28 px-6 bg-[#E6FAF8]">
      <div className="max-w-7xl mx-auto">
        ...
        <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {/* Omnicanal — wide */}
          <StaggerChild className="md:col-span-2 lg:col-span-2 bg-white rounded-3xl border border-teal-100 p-7 shadow-sm hover:shadow-md transition-shadow">
            <div className="flex items-center gap-3 mb-5">
              ...
              <div>
                <h3 className="font-bold text-[#1E293B]">Présence Omnicanale Unifiée</h3>
                <p className="text-sm text-slate-500">Google · Facebook · Instagram · Site web</p>
              </div>
            </div>
          ...
          {/* SEO */}
          <StaggerChild className="bg-white rounded-3xl border border-teal-100 p-7 shadow-sm hover:shadow-md transition-shadow">
          ...
          {/* Content — dark card */}
          <StaggerChild className="bg-[#1E293B] rounded-3xl p-7 shadow-sm hover:shadow-md transition-shadow">
            <div className="w-11 h-11 rounded-2xl bg-teal-500/20 flex items-center justify-center mb-4">
          ...
          {/* Reviews */}
          <StaggerChild className="bg-white rounded-3xl border border-teal-100 p-7 shadow-sm hover:shadow-md transition-shadow">
            <div className="w-11 h-11 rounded-2xl bg-yellow-100 flex items-center justify-center mb-4">
          ...
          <StaggerChild className="md:col-span-2 lg:col-span-3 bg-gradient-to-r from-teal-500 to-teal-600 rounded-3xl p-7 shadow-sm hover:shadow-md transition-shadow">
