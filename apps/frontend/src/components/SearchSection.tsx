...
function MeshGradient() {
  return (
    <div className="absolute inset-0 pointer-events-none overflow-hidden z-0">
      ...
      <div className="absolute -top-[120px] -right-[80px] w-[500px] h-[500px] rounded-full blur-[32px] bg-[radial-gradient(circle,rgba(31,58,95,0.15)_0%,transparent_70%)]" />

      {/* 2. Turquoise center-left (#14b8a6) - Apporte la touche de dynamisme */}
      <div className="absolute top-[80px] -left-[60px] w-[420px] h-[420px] rounded-full blur-[28px] bg-[radial-gradient(circle,rgba(20,184,166,0.12)_0%,transparent_70%)]" />

      {/* 3. Bleu foncé bottom-right (#1f3a5f) - Rappel subtil pour équilibrer */}
      <div className="absolute bottom-[60px] right-[10%] w-[300px] h-[300px] rounded-full blur-[24px] bg-[radial-gradient(circle,rgba(31,58,95,0.12)_0%,transparent_70%)]" />
    </div>
  );
}
// ── Search bar ────────────────────────────────────────────────────────────────
...
function SearchBar() {
  ...
  return (
    <div
      className={`relative flex items-center bg-white rounded-full border-[1.5px] transition-all duration-200 py-1.5 pl-6 pr-1.5 gap-0 w-full max-w-[620px] ${
        focused
    ...
    >
      {/* Search icon */}
      <Search
        className="shrink-0 mr-2.5 text-slate-400"
        size={16}
        strokeWidth={2.5}
      />
      ...
      <input
        ...
        className="flex-1 border-none outline-none text-[15px] font-sans text-slate-800 bg-transparent min-w-0 placeholder-slate-400"
      />
      ...
      */}
      ...
      {/* CTA button */}
      <button className="shrink-0 bg-orange-500 hover:bg-orange-600 text-white border-none rounded-full py-3 px-5 text-sm font-bold font-sans cursor-pointer shadow-[0_4px_12px_rgba(249,115,22,0.4)] transition-all duration-150 hover:-translate-y-[1px] whitespace-nowrap">
        Rechercher
      </button>
    </div>
  );
...
export default function Hero() {
  return (
    <section
      className="relative pt-10 min-h-screen w-full flex flex-col justify-center bg-cover bg-center bg-no-repeat overflow-hidden"
    ...
    >
      <div className="absolute inset-0 bg-[#1f3a5f]/65 backdrop-blur-[2px] z-0" />

      <MeshGradient />

      {/* Conteneur principal du texte et de la barre de recherche */}
      <div className="w-full max-w-[1180px] mx-auto px-6 relative z-10">
        {/* Headline */}
        <h1 className="text-[clamp(44px,7vw,82px)] font-black leading-[1.06] text-slate-800 font-[Poppins] font-sans tracking-[-3px] text-center max-w-[900px] mx-auto mb-6 text-white">
          Pilotez votre business
          <br />
          <span className="relative inline-block">
            avec{" "}
            <span className="bg-[#14b8a6] bg-clip-text text-transparent">
              précision
            </span>
          </span>
        </h1>
        ...
        {/* Subheadline */}
        <p className="text-[clamp(16px,2vw,20px)] text-slate-200 leading-relaxed text-center max-w-[560px] mx-auto mb-10 font-sans font-normal">
