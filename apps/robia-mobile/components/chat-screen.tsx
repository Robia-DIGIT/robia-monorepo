      ...
      >
        <View style={styles.header}>
          <View style={styles.brandMark}>
            <Text style={styles.brandLetters}>IA</Text>
          </View>
        ...
        >
          <View style={styles.introCard}>
            ...
            <Text style={styles.introText}>
              Des idées claires et des actions concrètes pour développer votre
              visibilité digitale.
            </Text>
          </View>
        ...
        <View style={styles.composerWrap}>
          ...
          <Text style={styles.prototype}>
            Mode prototype · les réponses peuvent être simulées
          </Text>
        </View>
      </KeyboardAvoidingView>
    </SafeAreaView>
