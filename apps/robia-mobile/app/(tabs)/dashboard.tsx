...
const styles = StyleSheet.create({
  ...
  scoreCard: { gap: 15, overflow: 'hidden', backgroundColor: Brand.tealLight, borderColor: 'rgba(20,184,166,0.12)' },
  ...
  scoreLabel: { color: Brand.tealDark, fontFamily: Fonts?.sans, fontSize: 13, fontWeight: '700' },
  scoreLine: { flexDirection: 'row', alignItems: 'baseline', marginTop: 3 },
  score: { color: Brand.navyDark, fontFamily: Fonts?.rounded, fontSize: 48, fontWeight: '900', letterSpacing: -1.5 },
  ...
  track: { height: 8, borderRadius: 99, overflow: 'hidden', backgroundColor: 'rgba(255,255,255,0.72)' },
