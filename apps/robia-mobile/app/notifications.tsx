...
const templates: Record<string,string> = { audit_completed: 'Audit terminé', automation_failed: 'Échec d’automatisation', weekly_opportunities_summary: 'Bilan des opportunités', odc_candidate_invite: 'Invitation ? poursuivre une candidature' };
...
export default function NotificationsScreen() {
  ...
  return <RobiaScreen fixedHeader><RobiaHeader compact back title="Suivi des envois" subtitle="Les e-mails déclenchés par vos automatisations." />
    <Choices value={filter} onChange={setFilter} options={[{ value: 'all', label: 'Tous' }, { value: 'sent', label: 'Envoyés' }, { value: 'failed', label: '? vérifier' }]} />
