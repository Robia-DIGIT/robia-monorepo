  ...
  return (
    <footer className="bg-[#0B222C] px-5 pb-8 pt-16 text-white sm:px-8 lg:px-12">
      <div className="mx-auto max-w-7xl">
        <div className="grid items-center gap-7 border-b border-white/15 pb-12 sm:grid-cols-[160px_1fr_auto]">
          <Link to="/">
            <img
              src={logo}
              alt="ROBIA"
          ...
          <p className="max-w-md text-sm leading-6 text-[#9AB0B7]">
            L’intelligence qui transforme votre présence locale en actions
            utiles.
          </p>
          <a
            href="/#produit"
            className="flex items-center gap-2 text-xs font-bold text-[#8FE1D6]"
          >
            Retour en haut <ArrowUp size={14} />
          </a>
        </div>
        <div className="grid gap-12 py-16 sm:grid-cols-2 lg:grid-cols-[1fr_150px_150px_150px]">
